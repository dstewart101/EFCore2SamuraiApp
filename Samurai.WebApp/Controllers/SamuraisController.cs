...
namespace Samurai.WebApp.Controllers
{
    public class SamuraisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] SamuraiApp.Domain.Samurai samurai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] SamuraiApp.Domain.Samurai samurai)
        {
            if (id != samurai.Id)
            {
                return NotFound();
